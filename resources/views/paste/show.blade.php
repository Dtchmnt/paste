    ...
    <div class="container">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12">
                        <ul class="list-inline">
                            ...
                            <li>Syntax: <i> {{ is_null($list_user->syntax) ? "Plain-text" : $list_user->syntax }} </i></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <pre><code class="{{ is_null($list_user->syntax) ? "nohighlight" : $list_user->syntax }}">{{ $list_user->text }}</code></pre>
                    </div>
                </div>
            </div>
        </div>
